...
addMaterialMapping("Wall_filler101m" , "detail: ClimbGame/data/interiors/lightingPack/wall_detail"); 
...
datablock DecalData(GlowDecal)
{
   sizeX       = 2;
   sizeY       = 2;
   textureName = "ClimbGame/data/shapes/lightingPack/Arrow";
...
{
  animateTexture = "0";
  animTexName[0] = "ClimbGame/data/shapes/particles/smoke";
  ...
  spinRandomMin = "-100";
  spinSpeed = "0.29";
  textureName = "ClimbGame/data/shapes/particles/smoke";
  times[0] = "0";
  times[1] = "0.49";
  times[2] = "1";
  times[3] = "1";
